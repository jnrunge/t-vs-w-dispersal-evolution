...
if (ticks = max-ticks)
[
  if(extended-disadvantage-adaptation = false and keep-going-after-max-ticks = false) ; false in Runge et al.
  [stop]
...
425
604
Dispersal propensity histogram
NIL
NIL
0.0
1.0
...
544
1515
For technical reasons there are more settings below here than I would recommend to try in the online version and/or outside of a deeper scientific inquiry.
11
0.0
1
